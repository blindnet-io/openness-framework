# Openness in Tech: An Explainer for Non-Tech People

> What Openness means to us, and why you should care.
...
But the era of secrets is long gone. We now live in an information society where people expect access to all the information they need, whenever they need. Secrecy in business and technology is now considered suspicious. With greater personal privacy expectations comes greater expectations of transparency.

It goes both ways. Customers, who now use social platforms on a daily basis, can't accept to be passive anymore. They want companies to offer them opportunities to get involved. To actively contribute.

The public is looking for transparency and collaboration, which is precisely what openness offers.
...
To cite the Journal of Information Technology, Openness is the association of _"accessibility of knowledge, technology and other resources; the transparency of action; the permeability of organizational structures; and the inclusiveness of participation"_[^2]. All of that, and more, allows us to build engagement and guarantee innovation.

## How To Make Money in The Open

Now, all companies need to make money of course. For that, we need to answer the needs of our customers. And in a constantly changing world, knowing what the public actually want is a real challenge[^3]. Building a successful product requires extensive surveys and tests to guarantee its market fit.

Openness provides a framework to lessen these needs considerably. By building a project and company with constant contributions from outsiders, we are guaranteed to receive most feedback we need without any additional effort or spending.

But this doesn't answer the main question all people have when talking about Open Businesses: how can we make money if we share our product with everyone? After all, companies like Louis Vuitton don't provide Open Specifications to show how to build my own luxury bad. There should be a good reason behind that.

And yes, there is. It is called branding. Luxury brands like Louis Vuitton need to guarantee a certain level of quality for their products, because it's linked to their brand image. Controlling manufacture is their only option[^4].

It isn't the case with Openness in technology. First, because the software is, by definition, immaterial. Copying it doesn't lessen its quality. And second because by adopting Openness principles, you can prove to your customers your mastery of the related topics.
...
First, there is the Big Corps, like Microsoft or Oracle. Their first common denominator is a very strong and well-established brand. People can trust them because of this brand image, without needing to collaborate with them actively.

Blindnet doesn't fit in this category, obviously. We are the new challenger who's here to disrupt the market with innovation and an outsider's perspective. We need to use weapons that fits this challenge.
...
At blindnet, we strongly believe this is the only way to go. That Openness and Privacy are two sides of the same coin. People's trust in us is based on facts, and nothing else.
